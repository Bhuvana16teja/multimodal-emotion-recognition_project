...
# ==================================================
EMB_ID = "1SInxhNwliik65H19X4HGxyCU0T1R2wTI"
LABEL_ID = "10lrQjDRoIzjfNQ0fiZ_ncvq7IA5igu_-"

# ==================================================
# DOWNLOAD TRAIN EMBEDDINGS
# ==================================================
if not os.path.exists("checkpoints/train_embeddings.pt"):

    print("Downloading train embeddings...")

    gdown.download(
        f"https://drive.google.com/uc?id={EMB_ID}",
        "checkpoints/train_embeddings.pt",
        quiet=False
    )
...
# ==================================================
if not os.path.exists("checkpoints/train_labels.pt"):

    print("Downloading train labels...")

    gdown.download(
        f"https://drive.google.com/uc?id={LABEL_ID}",
        "checkpoints/train_labels.pt",
        quiet=False
    )

print("Train embeddings and labels ready!")
...
torch.save(
    model.state_dict(),
    "models/speech_pipeline/best_model.pth"
)

print("\nTraining completed successfully!")

print("Model saved at:")
print("models/speech_pipeline/best_model.pth")
